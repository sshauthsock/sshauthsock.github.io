import{g as L}from"./components-KK9vAy1z.js";import{L as v}from"./utils-C4S-LQYV.js";import{q as D,t as O,v as R,r as k,p as e,w as x,u as p,e as a,i as W,S as w}from"./myInfo-common-D2CUTr8V.js";import{u as g,a as q}from"./myInfo-statCalculator-DRlyhEgC.js";import{r as T,u as n,h as G}from"./myInfo-statUI-CBQfCxnP.js";import{r as F,a as H,s as K,b as N,h as V,c as y,g as o,d as j,e as U,f as z}from"./myInfo-spiritManager-_dwAcAUk.js";import{s as _}from"./myInfo-eventHandlers-CPgYB7Zc.js";import"./main-BD5mqkRQ.js";import"./myInfo-engravingManager-CvXKMKsa.js";function b(t,u,i){G(t,u,i,o,f,q)}function c(t){F(t,$,(u,i,P,r)=>{K(u,i,P,r,{renderBondSlots:c,updateTotalStats:g,updateSoulExp:p,debouncedUpdateTotalStats:f,debouncedUpdateSoulExp:E,updateStatItemsWithValues:n,removeBondSpirit:Q,getSpiritsForCategory:o})})}function d(){H(J)}function $(t){N(t),d()}function J(t){V(t,c,d,f,E,g,n,o)}function Q(t,u){U(t,u,c,y,d,f,E,g,n,o)}function it(t){X(),t.innerHTML=D(),a.container=t,a.statsColumn1=t.querySelector("#statsColumn1"),a.statsColumn2=t.querySelector("#statsColumn2"),a.statsColumn3=t.querySelector("#statsColumn3"),a.spiritGrid=t.querySelector("#myInfoSpiritGrid"),a.spiritTabs=t.querySelectorAll(".my-info-spirit-tab"),a.totalStatsGrid=t.querySelector("#totalStatsGrid"),a.soulExpInfo=t.querySelector("#soulExpInfo"),a.profileSelect=t.querySelector("#profileSelect"),a.createProfileBtn=t.querySelector("#createProfileBtn"),a.editProfileBtn=t.querySelector("#editProfileBtn"),a.deleteProfileBtn=t.querySelector("#deleteProfileBtn"),a.bondSlots수호=t.querySelector("#bondSlots수호"),a.bondSlots탑승=t.querySelector("#bondSlots탑승"),a.bondSlots변신=t.querySelector("#bondSlots변신"),O(),R({renderBondSlots:c,renderActiveSpiritSelect:y,renderStats:()=>T(b),updateTotalStats:()=>g(o,n),updateSoulExp:()=>p(o)}),k(),T(b),["수호","탑승","변신"].forEach(r=>{c(r)}),d();const i=r=>{if(r.target.tagName==="IMG"&&r.target.src){const s=r.target;if(s.src.endsWith(".webp")&&s.dataset.fallbackAttempted!=="true"){const l=s.src.replace(/\.webp$/i,".jpg");s.dataset.fallbackAttempted="true",s.src=l;return}e.imageLoadErrors.add(s.src),W()}};t.querySelectorAll("img").forEach(r=>{r.onerror||r.addEventListener("error",i)}),e.imageObserver=new MutationObserver(r=>{r.forEach(s=>{s.addedNodes.forEach(l=>{if(l.nodeType===1){l.tagName==="IMG"&&l.addEventListener("error",i);const S=l.querySelectorAll&&l.querySelectorAll("img");S&&S.forEach(m=>{m.addEventListener("error",i)})}})})}),e.imageObserver.observe(t,{childList:!0,subtree:!0}),_({renderBondSlotsWrapper:c,renderActiveSpiritSelect:y,renderSpiritListWrapper:d,handleStatEditWrapper:b}),x().catch(r=>{v.error("Error preloading exp table:",r)}),Promise.all([g(o,n),p(o)]).then(()=>{const r=[...w],s=e.lastTotalStatsCalculation;if(!(!s||!s.allTotalStats)){if(Object.keys(e.baselineStats).length===0){r.forEach(h=>{const I=e.userStats[h.key]||0,C=s.allTotalStats[h.key]||0,A=Math.round(I+C);e.baselineStats[h.key]=A});const l=Math.round((e.userStats.damageResistancePenetration||0)+(s.allTotalStats.damageResistancePenetration||0)),S=Math.round((e.userStats.damageResistance||0)+(s.allTotalStats.damageResistance||0)),m=Math.round((e.userStats.pvpDamagePercent||0)+(s.allTotalStats.pvpDamagePercent||0)),M=Math.round((e.userStats.pvpDefensePercent||0)+(s.allTotalStats.pvpDefensePercent||0)),B=Math.round(l+S+Math.round(m*10)+Math.round(M*10));e.baselineKeyStats.tachaeTotal=B,e.baselineKeyStats.statusEffectResistance=Math.round((e.userStats.statusEffectResistance||0)+(s.allTotalStats.statusEffectResistance||0)),e.baselineKeyStats.statusEffectAccuracy=Math.round((e.userStats.statusEffectAccuracy||0)+(s.allTotalStats.statusEffectAccuracy||0))}n(r,s.allTotalStats,{},!0),q(r,s.allTotalStats,{},!0),e.isInitialLoad=!1}}).catch(r=>{v.error("Error initializing stats:",r),e.isInitialLoad=!1})}const f=L(()=>{g(o,n)},800),E=L(()=>{p(o)},800);function nt(){return`
