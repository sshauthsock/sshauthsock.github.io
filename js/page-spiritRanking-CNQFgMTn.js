import{g as k,s as C,i as E}from"./main-BSM0d3_v.js";import{c as m,S as p,G as T,F as L,a as $}from"./components-D3TUJV6-.js";import{s as R}from"./page-spiritInfo-y68npLBX.js";import{s as M}from"./page-bondCalculator-DLbMILYZ.js";import{E as h}from"./utils-_hhoRv_V.js";const d={currentCategory:"수호",currentRankingType:"bond",currentStatKey:"bind",currentLoadedRankings:[]},i={};function x(t,a){const e=[],n=T[a];return n&&Object.entries(t).forEach(([s,r])=>{const o=n[s];if(!o)return;let l=0;for(let c=2;c<=r;c++)o[c.toString()]&&(l=c);if(l>0){const c=o[l.toString()];Object.entries(c).forEach(([f,g])=>{e.push({key:f,name:p[f]||f,value:g})})}}),e}function w(t,a){const e=[],n=L[a];return n&&Object.entries(t).forEach(([s,r])=>{const o=n[s];if(!o)return;let l=0;for(let c=2;c<=r;c++)o[c.toString()]&&(l=c);if(l>0){const c=o[l.toString()];Object.entries(c).forEach(([f,g])=>{e.push({key:f,name:p[f]||f,value:g})})}}),e}function H(){return`
  ...
  `}async function v(){A();try{const t=await k(d.currentCategory,d.currentRankingType,d.currentStatKey);d.currentLoadedRankings=t.rankings||[],F(d.currentLoadedRankings)}catch(t){h.handle(t,"랭킹 데이터 로드"),i.rankingsContainer.innerHTML=`
