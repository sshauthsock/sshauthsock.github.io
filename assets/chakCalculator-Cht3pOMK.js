import{b as v}from"./utils-CHsLvtYz.js";import{a as _,e as F,h as O,g as N}from"./index-p72KxVfY.js";import{a as K}from"./supportMessage-C6tx5lCv.js";let b=null;function T(e){return e.replace(/\d+$/,"")}function A(e,t,a,n,i){L();const o=v("div","modal-overlay",{id:"modernChakResultsModal"}),r=v("div","modal-content");if(o.appendChild(r),document.body.appendChild(o),!document.querySelector('link[href*="chakra-results-modern.css"]')){const m=document.createElement("link");m.rel="stylesheet",m.href="public/assets/css/chakra-results-modern.css",document.head.appendChild(m)}const c=v("button","modal-close",{text:"✕"});c.addEventListener("click",L),r.appendChild(c);const d=v("div","kakao-ad-modal-container desktop-modal-ad");d.innerHTML=`
