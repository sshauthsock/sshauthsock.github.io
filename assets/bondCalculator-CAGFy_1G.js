import{a as T,c as k,h as x,s as h}from"./index-7BHmx9Br.js";import{b as v,a as F,c as A}from"./utils-CHsLvtYz.js";import{a as O,s as q}from"./resultModal-DOvUi161.js";import{c as w,r as H}from"./statFilter-C1yLqHyh.js";import"./constants-lx1P6xCQ.js";const i={currentCategory:"수호",selectedSpirits:new Map,groupByInfluence:!1,currentStatFilter:""},a={};function N(){return`
    ...
    `}function Q(){a.container&&a.container.removeEventListener("click",C),a.influenceToggle&&a.influenceToggle.removeEventListener("change",E),a.selectedSpiritsList&&a.selectedSpiritsList.removeEventListener("input",u),a.selectAllBtn&&a.selectAllBtn.removeEventListener("click",I),a.clearAllSelectionBtn&&a.clearAllSelectionBtn.removeEventListener("click",M),a.applyBatchLevelBtn.removeEventListener("click",()=>p("batchLevelInput")),a.findOptimalBtn.removeEventListener("click",g);const e=document.getElementById("panelToggleBtn"),t=document.getElementById("selectedSpiritsMobile"),n=document.getElementById("applyMobileBatchLevelBtn"),l=document.getElementById("setMaxMobileBatchLevelBtn"),s=document.getElementById("findOptimalMobileBtn");e&&e.removeEventListener("click",S),t&&t.removeEventListener("input",u),n&&n.removeEventListener("click",y),l&&l.removeEventListener("click",B),s&&s.removeEventListener("click",L);const r=document.getElementById("panelToggleContainer");r&&r.remove(),console.log("환수 결속 페이지 정리 완료.")}export{Q as cleanup,K as getHelpContentHTML,D as init};
