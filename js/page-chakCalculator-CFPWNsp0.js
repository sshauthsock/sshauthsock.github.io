import{c as p,f as T,g as P}from"./components-C2RsvHY9.js";import{b as I,d as H,h as j}from"./main-Bgn-9pGL.js";import{E as k}from"./utils-x5ORUUhl.js";const l={chakData:null,selectedPart:null,selectedLevel:null,userResources:{goldButton:1e4,colorBall:1e4},statState:{},allAvailableStats:[],selectedStats:[]},s={};function A(){return`
  ...
  `}async function W(e){e.innerHTML=A(),s.container=e,s.equipmentSelector=e.querySelector("#equipment-selector"),s.levelSelector=e.querySelector("#level-selector"),s.statsDisplay=e.querySelector("#stats-display"),s.summaryDisplay=e.querySelector("#summary-display"),s.goldButton=e.querySelector("#gold-button"),s.colorBall=e.querySelector("#color-ball"),s.bossPresetBtn=e.querySelector("#boss-preset-btn"),s.pvpPresetBtn=e.querySelector("#pvp-preset-btn"),s.searchInput=e.querySelector("#search-input"),s.searchButton=e.querySelector("#search-button"),s.statOptions=e.querySelector("#stat-options"),s.selectedStats=e.querySelector("#selected-stats"),s.resourceSummary=e.querySelector("#resource-summary"),I(e,"착 데이터 로딩 중...","서버에서 착 정보를 불러오고 있습니다...");try{l.chakData=await H(),K(),z(),x(),v(),g(!0),s.equipmentSelector.addEventListener("click",m),s.levelSelector.addEventListener("click",m),s.statsDisplay.addEventListener("click",O),s.goldButton.addEventListener("input",h),s.colorBall.addEventListener("input",h),s.bossPresetBtn.addEventListener("click",()=>y("boss")),s.pvpPresetBtn.addEventListener("click",()=>y("pvp")),R()}catch(t){k.handle(t,"Chak page init"),e.innerHTML=`
      <div class="error-message" style="text-align: center; padding: 2rem;">
        <h3>${k.getUserFriendlyMessage(t.message)}</h3>
      </div>
    `}finally{j()}}function X(){s.equipmentSelector&&s.equipmentSelector.removeEventListener("click",m),s.levelSelector&&s.levelSelector.removeEventListener("click",m),s.statsDisplay&&s.statsDisplay.removeEventListener("click",O),s.goldButton&&s.goldButton.removeEventListener("input",h),s.colorBall&&s.colorBall.removeEventListener("input",h),s.bossPresetBtn&&s.bossPresetBtn.removeEventListener("click",()=>y("boss")),s.pvpPresetBtn&&s.pvpPresetBtn.removeEventListener("click",()=>y("pvp")),s.searchInput&&s.searchInput.removeEventListener("click",e=>e.stopPropagation()),s.searchInput&&s.searchInput.removeEventListener("input",()=>f(s.searchInput.value)),s.searchButton&&s.searchButton.removeEventListener("click",M),document.removeEventListener("click",()=>{s.statOptions.style.display="none"})}function x(){const{parts:e,levels:t}=l.chakData.constants;l.selectedPart=`${e[0]}_0`,l.selectedLevel=t[0],s.equipmentSelector.innerHTML="",s.levelSelector.innerHTML="",e.forEach((n,a)=>{const o=`${n}_${a}`,r=p("button","selector-btn equip-btn",{text:n,"data-part-id":o});s.equipmentSelector.appendChild(r)}),t.forEach(n=>{const a=p("button","selector-btn level-btn",{"data-level":n});a.innerHTML=`
        ...
        `,s.levelSelector.appendChild(a)}),S()}function v(){if(!l.selectedPart||!l.selectedLevel)return;const e=l.selectedPart.split("_")[0],t=`lv${l.selectedLevel.replace("+","")}`,n=l.chakData.equipment[e]?.[t]||{};s.statsDisplay.innerHTML="";let a=0;Object.entries(n).forEach(([o,r])=>{const c=`${o}_${l.selectedPart}_${l.selectedLevel}_${a}`,i=l.statState[c]||{level:0,value:0,isUnlocked:!1,isFirst:!1},d=F(o,r,i,c,a);s.statsDisplay.appendChild(d),a++}),q(),E()}function F(e,t,n,a,o){const r=e.replace(/\d+$/,""),c=p("div","stat-card",{"data-card-id":a,"data-stat-index":o,"data-stat-name":e});return c.innerHTML=`
